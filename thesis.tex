...
\begin{document}
    ...
    \title{ANALISIS KOMPARATIF VISION MAMBA DAN MAMBA-YOLO UNTUK ESTIMASI KEPADATAN RUANGAN BERBASIS KEPALA MANUSIA }
    % Judul Tugas Akhir dalam Bahasa Inggris
    \titleEN{COMPARATIVE ANALYSIS OF VISION MAMBA AND MAMBA-YOLO FOR ROOM DENSITY ESTIMATION BASED ON HUMAN HEADS }
    % JUDUL AKAN DITULIS DALAM HURUF KAPITAL; Font size 16 pt; Bold; Tidak melebihi 4 baris
    
    % Informasi Mahasiswa
	\author{M. Arief Rahman Hakim}		% Nama Mahasiswa
	\nim{122140083}				% NIM Mahasiswa
	
	%Informasi Dosen Pembimbing
	\dosbingA%
		{Rahman Indra Kesuma, S.Kom., M.Cs.}%	% Nama Dosen Pembimbing 1
		{NIP. 19910530 201903 1 018}				% NIP Dosen Pembimbing 1
	\dosbingB%
